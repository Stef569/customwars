...
public class TestData {
    ...
    // Units
    private static Unit infantry = new Unit(0, "Infantry", "", 3000, 3, 3, UNIT_MAX_HP, MAX_UNIT_SUPPLIES, 0, 0, true, false, false, false, true, null, ARMY_BRANCH_GROUND, MOVE_INF, 0, 0);
    private static Unit mech = new Unit(1, "Mech", "", 3000, 3, 3, UNIT_MAX_HP, MAX_UNIT_SUPPLIES, 0, 0, true, false, false, false, true, null, ARMY_BRANCH_GROUND, MOVE_MECH, 0, 0);
    ...
    private static Unit tank = new Unit(4, "Tank", "", 7000, 6, 3, UNIT_MAX_HP, MAX_UNIT_SUPPLIES, 0, 0, false, false, false, false, true, null, ARMY_BRANCH_GROUND, MOVE_TREAD, 0, 0);
    private static Unit rocket = new Unit(7, "Rockets", "", 14000, 5, 1, UNIT_MAX_HP, MAX_UNIT_SUPPLIES, 0, 0, false, false, false, false, true, null, ARMY_BRANCH_GROUND, MOVE_TIRES, 0, 0);
    private static Unit artillery = new Unit(9, "Artillery", "", 6000, 5, 1, UNIT_MAX_HP, 50, 0, 0, false, false, false, false, true, null, ARMY_BRANCH_GROUND, MOVE_TREAD, 0, 0);
