...
public class PathTest {
  ...
  public void testDestinationReachableThroughPipeSeam() {
    ...
    // Move the unit towards the destination (it will take 4 turns)
    ...
    List<Location> path4 = pathFinder.getShortestPath(unit, HQ.getLocation());
    Assert.assertFalse(path4.isEmpty());
    map.teleport(unit.getLocation(), path4.get(path4.size() - 1), unit);
