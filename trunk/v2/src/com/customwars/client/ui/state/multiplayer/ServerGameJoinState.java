...
import com.customwars.client.controller.multiplayer.ServerGameJoinController;
 ...
 */
public class ServerGameJoinState extends CWState {
  private Page page;
  private Image backGroundImage;
  private ServerGameJoinController controller;

  public void init(GameContainer gameContainer, StateBasedGame stateBasedGame) throws SlickException {
    controller = new ServerGameJoinController(stateChanger);
    initPage();
  ...
  private void initPage() {
    ...
    page = thingleLoader.loadPage("ServerGameJoin.xml", "greySkin.properties", controller);
  }
