...
/**
 * Create in game actions. The actions change the game model and update the screen.
 */
public class ActionFactory {
  ...
  public static CWAction buildMoveAction(Unit unit, Location moveTo) {
    ...
    moveActions.add(new MoveAnimatedAction(unit, unit.getLocation(), moveTo));
  ...
  public static CWAction buildCaptureAction(Unit unit, City city) {
    ...
    captureActions.add(new MoveAnimatedAction(unit, unit.getLocation(), city.getLocation()));
  ...
  public static CWAction buildLoadAction(Unit unit, Unit transport) {
    ...
    loadActions.add(new MoveAnimatedAction(unit, unit.getLocation(), transport.getLocation()));
  ...
  public static CWAction buildSupplyAction(Unit supplier, Location moveTo) {
    ...
    supplyActions.add(new MoveAnimatedAction(supplier, supplier.getLocation(), moveTo));
  ...
  public static CWAction buildJoinAction(Unit unit, Unit target) {
    ...
    joinActions.add(new MoveAnimatedAction(unit, unit.getLocation(), target.getLocation()));
  ...
  public static CWAction buildUnitVsUnitAttackAction(Unit attacker, Unit defender, Location moveTo) {
    ...
    attackActions.add(new MoveAnimatedAction(attacker, attacker.getLocation(), moveTo));
  ...
  public static CWAction buildLaunchRocketAction(Unit unit, City city, Location rocketDestination) {
    ...
    launchRocketActions.add(new MoveAnimatedAction(unit, unit.getLocation(), city.getLocation()));
  ...
  public static CWAction buildTransformTerrainAction(Unit unit, Location to, Terrain transformTo) {
    ...
    transformTerrainActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
  ...
  public static CWAction buildFireFlareAction(Unit unit, Location to, Location flareCenter) {
    ...
    flareActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
  ...
  public static CWAction buildConstructCityAction(Unit unit, String cityID, Location to) {
    ...
    constructCityActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
  ...
  public static CWAction buildDiveAction(Unit unit, Location to) {
    ...
    diveActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
  ...
  public static CWAction buildSurfaceAction(Unit unit, Location to) {
    ...
    surfaceActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
  ...
  public static CWAction buildLoadCOAction(Unit unit, Location to) {
    ...
    loadCOActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
  ...
  public static CWAction buildCOPowerAction(Unit unit, Location to) {
    ...
    coPowerActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
  ...
  public static CWAction buildCOSuperPowerAction(Unit unit, Location to) {
    ...
    coSuperPowerActions.add(new MoveAnimatedAction(unit, unit.getLocation(), to));
