...
public class HardCodedGame {
  ...
  public static Terrain plain = new Terrain(0, "plain", "", (byte) 0, (byte) 0, plainMoveCosts);
  public static Terrain verticalRiver = new Terrain(20, "River", "", (byte) 0, (byte) -1, riverMoveCosts);
