...
public final class TerrID 
{
	//MAX TERRAIN COUNT
	public static final int MAX_TERRAIN_TYPES = 23;
	...
	public static final int MISSILE_SILO = 16;
	public static final int PIPE_STATION = 17;
	public static final int PIPE_SEAM = 18;
	public static final int DESTROYED_SEAM = 19;	
	public static final int SUSPENSION = 20;
	public static final int WALL = 21;
	public static final int DESTROYED_WALL = 22;
}
