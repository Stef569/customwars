...
public class Mission {
    ...
    public static void saveInitialState(){
        if(battle1 != null){
            try{
                ObjectOutputStream write = new ObjectOutputStream(new FileOutputStream("replay.save"));
                write.writeObject(battle1);
                ObjectInputStream read = new ObjectInputStream(new FileInputStream("replay.save"));
    ...
    public static void loadReplay(String filename){
        ...
        if(Options.isMusicOn()){
            Music.stopMusic();
            Music.startMusic(battle1.getArmy(battle1.getTurn()).getCO().getID());
        }
    ...
    public static void recieveMission(InputStream in){
        ...
        if(Options.isAutosaveOn())saveMission("temp.save");
    }
