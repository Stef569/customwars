...
public class Sami extends CO{
    ...
    public Sami() {
        ...
        String superPowerStringx = "All foot soldiers can capture in one turn even if they're not at full HP. Thier movement increased by two spaces and their attack also increases greatly. "; //Holds the Super description
        String intelx = "Sami's good at infantry. There was a conflict in merging, augasdf";
        CObio = CObiox;
        title = titlex;
        hit = hitx;
        miss = missx;
