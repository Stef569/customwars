        ...
        for(int i = 0; i<armies.length; i++)
        {
            if(armies[i].getSide() != army.getSide())
            {
                ...
                for(int s = 0; s<u.length; s++)
                {
                    ...
                    u[s].enemyCOstore[statIndex] = army.getBattle().getMap().find(u[s]).getTerrain().getDef() * u[s].getDisplayHP()* 2; 
                    ...
                    u[s].enemyCOstore[statIndex] += army.getBattle().getMap().find(u[s]).getTerrain().getDef() * u[s].getDisplayHP()* 1;   
                    }
                }
            }
        }
