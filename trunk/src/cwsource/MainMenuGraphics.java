...
public class MainMenuGraphics {
    ...
    public static void loadImages(Component screen){
        background = new ImageIcon("images/misc/mainmenu/background.png").getImage();
        newGame = new ImageIcon("images/misc/mainmenu/newgame.gif").getImage();
        newGameSelected = new ImageIcon("images/misc/mainmenu/newgame2.gif").getImage();
        maps = new ImageIcon("images/misc/mainmenu/maps.gif").getImage();
        mapsSelected = new ImageIcon("images/misc/mainmenu/maps2.gif").getImage();
        options = new ImageIcon("images/misc/mainmenu/options.gif").getImage();
        optionsSelected = new ImageIcon("images/misc/mainmenu/options2.gif").getImage();
        coLayout = new ImageIcon("images/misc/mainmenu/co_layout.gif").getImage();
        mapLayout = new ImageIcon("images/misc/mainmenu/map_layout.gif").getImage();
        noCO = new ImageIcon("images/misc/mainmenu/noco.gif").getImage();
        nowDrawing = new ImageIcon("images/misc/mainmenu/nowprinting.gif").getImage();
        titleBackground = new ImageIcon("images/misc/mainmenu/titlebg.png").getImage();
        logo = new ImageIcon("images/misc/mainmenu/cwlogo.gif").getImage();
        pgup = new ImageIcon("images/misc/mainmenu/pgup.gif").getImage();
        pgdn = new ImageIcon("images/misc/mainmenu/pgdn.gif").getImage();
        cobanner = new ImageIcon("images/misc/mainmenu/cobanner.gif").getImage();
        coslot = new ImageIcon("images/misc/mainmenu/slot.gif").getImage();
        pnum = new ImageIcon("images/misc/mainmenu/numbers.gif").getImage();
        conametag = new ImageIcon("images/misc/mainmenu/conametag.gif").getImage();
        hqbg = new ImageIcon("images/misc/mainmenu/hqbg.gif").getImage();
        baseone = new ImageIcon("images/misc/mainmenu/base1.gif").getImage();
        basetwo = new ImageIcon("images/misc/mainmenu/base2.gif").getImage();
        emblem = new ImageIcon("images/misc/mainmenu/logos.gif").getImage();
        tagstar = new ImageIcon("images/misc/mainmenu/tagstar.gif").getImage();
        
        for(int i = 0; i < 8; i++){
            tags[i] = new ImageIcon("images/misc/mainmenu/tab"+(i+1)+".gif").getImage();
