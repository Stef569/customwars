               ...
               //Now to blind enemy units
                ...
                if(units != null)
                {
                   for(int s = 0; s < units.length; s++)
                   {
                       ...
                       {
                           units[s].vision--;
                           units[s].enemyCOstore[statIndex] = 5;
                       }
                       else
                       {
                           //return;
                ...
                if(units != null)
                {
                   for(int s = 0; s < units.length; s++)
                   {
                       if(units[s].getClass() != null)
                       {
                          ...
                          if(army.getCO() == this)
                          {
                             if(units[s].enemyCOstore[statIndex] == 5)
                             {
                                 units[s].vision++;
                                 units[s].enemyCOstore[statIndex] = 0;
                             }
                          }
                          else
                          {
                             if(units[s].altEnemyCOstore[statIndex] == 5)
                             {
                                 units[s].vision++;
                                 units[s].altEnemyCOstore[statIndex] = 0;
                             }
                          }
                       }
                       else
