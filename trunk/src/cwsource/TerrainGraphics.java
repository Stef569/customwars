...
public class TerrainGraphics{
    ...
    public static void loadImages(Component screen){
        ...
        baseUrban = new ImageIcon("images/terrain/urban.gif").getImage();
        baseHQ = new ImageIcon("images/terrain/hq.gif").getImage();
        //Neutral Properties
        ...
        terrain = new ImageIcon("images/terrain/terrain.gif").getImage();
    }
