...
public class MiscGraphics {
    private static String[] coFilenames = {"andy","max","sami","nell","hachi","jake","rachel","olaf","grit","colin","sasha","eagle","drake","jess","javier","kanbei","sonja","sensei","grimm","flak","lash","adder","hawke","sturm","jugger","koal","kindle","vonbolt","ember","mina","epoch","peter","sabaki","edge","alexis","alex","graves","talyx","yukio","ozzy","edward","conrad","eric","nana", "melanthe", "falcone", "julia", "zandra", "carmen", "carrie", "amy", "sophie","mary","thanatos","napoleon","aira", "koshi", "artemis", "tempest", "rattigan", "roboandy", "sanjuro","xavier","adam","walter","joey","varlot", "eniac","minamoto","smitan"};
    ...
    private static Image coSheets[] = new Image[coFilenames.length];    //The CO spritesheets
    ...
    public static void loadImages(Component screen){
        attackTile = new ImageIcon("images/misc/attacktile.gif").getImage();
        moveTile = new ImageIcon("images/misc/movetile.gif").getImage();
        siloCursor = new ImageIcon("images/misc/silocursor.gif").getImage();
        hiddenHP = new ImageIcon("images/misc/hidden.gif").getImage();
        captureIcon = new ImageIcon("images/misc/capture.gif").getImage();
        loadIcon = new ImageIcon("images/misc/load.gif").getImage();
        diveIcon = new ImageIcon("images/misc/dive.gif").getImage();
        lowAmmoIcon = new ImageIcon("images/misc/lowammo.gif").getImage();
        lowFuelIcon = new ImageIcon("images/misc/lowfuel.gif").getImage();
        minimap = new ImageIcon("images/misc/minimap.gif").getImage();
        detect = new ImageIcon("images/misc/detect.gif").getImage();
        battleBackground = new ImageIcon("images/misc/battlebg.png").getImage();
        
        for(int i = 0; i < 10; i++){
            dayStartScreens[i] = new ImageIcon("images/misc/dayprog"+ i + ".gif").getImage();
        }
        
        for(int i = 0; i < 14; i++){
            cursor[i] = new ImageIcon("images/misc/cursors/cursor" + i + ".gif").getImage();
        }
        ...
        for(int i = 0; i < 10; i++){
            coBars[i] = new ImageIcon("images/misc/cobar"+ i + ".gif").getImage();
            coBarsReverse[i] = new ImageIcon("images/misc/cobar"+ i + "r.gif").getImage();
            altCOBars[i] = new ImageIcon("images/misc/tagcobar"+ i + ".gif").getImage();
            altCOBarsReverse[i] = new ImageIcon("images/misc/tagcobar"+ i + "r.gif").getImage();
        }
        
        for(int i = 0; i < 10; i++){
            moneyDisplay[i] = new ImageIcon("images/misc/money/"+ i + ".gif").getImage();
        }
        gold = new ImageIcon("images/misc/money/gold.gif").getImage();
        questionMark = new ImageIcon("images/misc/money/question_mark.gif").getImage();
        
        for(int i = 0; i < 7; i++){
            smallStars[i] = new ImageIcon("images/misc/stars/small"+ i + ".gif").getImage();
            bigStars[i] = new ImageIcon("images/misc/stars/large"+ i + ".gif").getImage();
        }
        power = new ImageIcon("images/misc/stars/cop.gif").getImage();
        superPower = new ImageIcon("images/misc/stars/scop.gif").getImage();
        tagBreak = new ImageIcon("images/misc/stars/tag_break.gif").getImage();
        
        for(int i = 0; i < coFilenames.length; i++){
            coSheets[i] = new ImageIcon("images/misc/sheets/"+coFilenames[i]+".gif").getImage();
        }
        
        for(int i = 1; i < 4; i++){
            if(i!=3)rain[i-1] = new ImageIcon("images/misc/weather/rain"+ i + ".gif").getImage();
            snow[i-1] = new ImageIcon("images/misc/weather/snow"+ i + ".gif").getImage();
            sand[i-1] = new ImageIcon("images/misc/weather/sandstorm"+ i + ".gif").getImage();
        }
        
        sky = new ImageIcon("images/misc/victory/sky.gif").getImage();
        win = new ImageIcon("images/misc/victory/win.gif").getImage();
        lose = new ImageIcon("images/misc/victory/lose.gif").getImage();
        days = new ImageIcon("images/misc/victory/days.gif").getImage();
        statsBox = new ImageIcon("images/misc/stats/form.gif").getImage();
        
        skill = new ImageIcon("images/misc/skill.gif").getImage();
        COP = new ImageIcon("images/misc/power.gif").getImage();
        SCOP = new ImageIcon("images/misc/super.gif").getImage();
        hit = new ImageIcon("images/misc/hit.gif").getImage();
        miss = new ImageIcon("images/misc/miss.gif").getImage();

        arrow[0] = new ImageIcon("images/misc/arrow/h.gif").getImage();
        arrow[1] = new ImageIcon("images/misc/arrow/v.gif").getImage();
        arrow[2] = new ImageIcon("images/misc/arrow/ne.gif").getImage();
        arrow[3] = new ImageIcon("images/misc/arrow/se.gif").getImage();
        arrow[4] = new ImageIcon("images/misc/arrow/sw.gif").getImage();
        arrow[5] = new ImageIcon("images/misc/arrow/nw.gif").getImage();
        arrow[6] = new ImageIcon("images/misc/arrow/n.gif").getImage();
        arrow[7] = new ImageIcon("images/misc/arrow/e.gif").getImage();
        arrow[8] = new ImageIcon("images/misc/arrow/s.gif").getImage();
        arrow[9] = new ImageIcon("images/misc/arrow/w.gif").getImage();

        airExplode = new ImageIcon("images/misc/air.gif").getImage();
        groundExplode = new ImageIcon("images/misc/land.gif").getImage();
        seaExplode = new ImageIcon("images/misc/water.gif").getImage();
        explodeDelay = 45; //Takes 48 frames, or .9 seconds.
        siloExplode = new ImageIcon("images/misc/siloexplosion.gif").getImage();
        siloDelay = 55; //Takes 1200ms, but a 100ms delay is accounted for
        
        missileup = new ImageIcon("images/misc/missileup.gif").getImage();
        
        Pointer = new ImageIcon("images/misc/point.gif").getImage();
	...
	//do it, I'm in a rush ;_; - kosheh
        ANpowerBack = new ImageIcon("images/misc/power/ANback.gif").getImage();
	DApowerBack = new ImageIcon("images/misc/power/DAback.gif").getImage();
        superPowerIcon = new ImageIcon("images/misc/power/superpower.gif").getImage(); 
        dialogueBox = new ImageIcon("images/misc/power/diagbox.gif").getImage();
	//THE HEART OF THE COLOR CODING~!! - kosheh
        ...
        for(int i = 0; i<26; i++)
        {
            smallfont[i] = new ImageIcon("images/misc/power/font/" + c.forDigit(i+10,36)+"smal1.gif").getImage();
            capitalfont[i] = new ImageIcon("images/misc/power/font/" + c.forDigit(i+10,36)+"1.gif").getImage();
        }
        
        aimCursor = new ImageIcon("images/misc/cursors/aimcursor0.gif").getImage();
        smallHeart = new ImageIcon("images/misc/smallheart.gif").getImage();
    }
