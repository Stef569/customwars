...
public class UnitGraphics 
{
    ...
    public static void loadImages(Component screen)
    {
        ...
        unitSheet = new ImageIcon("images/units/units.gif").getImage();
        rUnitSheet = new ImageIcon("images/units/unitsr.gif").getImage();
        infSheet = new ImageIcon("images/units/infantry.gif").getImage();
        rInfSheet = new ImageIcon("images/units/infantryr.gif").getImage();
        moveUnitSheet[0] = new ImageIcon("images/units/units_up.gif").getImage();
        moveUnitSheet[1] = new ImageIcon("images/units/units_right.gif").getImage();
        moveUnitSheet[2] = new ImageIcon("images/units/units_down.gif").getImage();
        moveUnitSheet[3] = new ImageIcon("images/units/units_left.gif").getImage();

                
        //This stuff is new!
        SFWiSheet = new ImageIcon("images/units/SFW_Inf.gif").getImage();
        SFWriSheet = new ImageIcon("images/units/SFW_Infr.gif").getImage();
    ...
    {
        if(targUnit.getArmy().getCO().COPName.equals("Quirky Berserky") && 
