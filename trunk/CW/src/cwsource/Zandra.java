...
public class Zandra extends CO
{
    ...
    public int getAtk(Unit owned, Unit enemy)
    {
        ...
        army.getCO().enemyTerrainPenalty = 0;
        army.getCO().terrainDefenseMultiplier = 1;
        ...
        {           
            ...
            if(eneTDef > ownTDef)
            {
                owned.getArmy().getCO().enemyTerrainPenalty = eneTDef - ownTDef;
                owned.getArmy().getCO().terrainDefenseMultiplier = (double)eneTDef / ownTDef;
            }
        }
...
//used to deactivate Olaf's Super CO Power the next day
    ...
    {       
        if(sandShiftBonus)
        {   
            owned.getArmy().getCO().enemyTerrainPenalty = 0;
            owned.getArmy().getCO().terrainDefenseMultiplier = 1;
        }
    }
} 