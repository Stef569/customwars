...
import com.customwars.officer.Adam;
import com.customwars.officer.Adder;
import com.customwars.officer.Amy;
import com.customwars.officer.Andy;
import com.customwars.officer.Carmen;
import com.customwars.officer.Colin;
import com.customwars.officer.Conrad;
import com.customwars.officer.Drake;
import com.customwars.officer.Eagle;
import com.customwars.officer.Edward;
import com.customwars.officer.Ember;
import com.customwars.officer.Epoch;
import com.customwars.officer.Eric;
import com.customwars.officer.Falcone;
import com.customwars.officer.Flak;
import com.customwars.officer.Graves;
import com.customwars.officer.Grimm;
import com.customwars.officer.Grit;
import com.customwars.officer.Hachi;
import com.customwars.officer.Hawke;
import com.customwars.officer.Jake;
import com.customwars.officer.Jared;
import com.customwars.officer.Javier;
import com.customwars.officer.Jess;
import com.customwars.officer.Jugger;
import com.customwars.officer.Kanbei;
import com.customwars.officer.Kindle;
import com.customwars.officer.Koal;
import com.customwars.officer.Koshi;
import com.customwars.officer.Lash;
import com.customwars.officer.Mary;
import com.customwars.officer.Max;
import com.customwars.officer.Minamoto;
import com.customwars.officer.Napoleon;
import com.customwars.officer.Nell;
import com.customwars.officer.Olaf;
import com.customwars.officer.Ozzy;
import com.customwars.officer.Peter;
import com.customwars.officer.Rachel;
import com.customwars.officer.Rattigan;
import com.customwars.officer.Sabaki;
import com.customwars.officer.Sami;
import com.customwars.officer.Sasha;
import com.customwars.officer.Sensei;
import com.customwars.officer.Smitan;
import com.customwars.officer.Sonja;
import com.customwars.officer.Sophie;
import com.customwars.officer.Varlot;
import com.customwars.officer.VonBolt;
import com.customwars.officer.Yukio;
