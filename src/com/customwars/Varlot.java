        ...
        for(int i = 0; i< armies.length; i++) {
            if(armies[i].getSide() == army.getSide()) {
                ...
                for(int s = 0; s<armies.length; s++) {
                    if(u[s].noRepair)
                        u[s].enemyCOstore[statIndex][0]+=1;
                    if(u[s].noResupply)
                        u[s].enemyCOstore[statIndex][0]+=2;
                    if(u[s].noCityRepair)
                        u[s].enemyCOstore[statIndex][0]+=4;
                    if(u[s].noCityResupply)
                        u[s].enemyCOstore[statIndex][0]+=8;
                    u[s].noRepair = true;
                    u[s].noResupply = true;
            ...
            for(int i = 0; i< armies.length; i++) {
                if(armies[i].getSide() == army.getSide()) {
                    ...
                    for(int s = 0; s<armies.length; s++) {
                        ...
                        if(u[s].enemyCOstore[statIndex][0]%2 == 1)
                            u[s].noRepair = false;
                        if(u[s].enemyCOstore[statIndex][0]/2%2 == 1)
                            u[s].noResupply = false;
                        if(u[s].enemyCOstore[statIndex][0]/4%2 == 1)
                            u[s].noCityRepair = false;
                        if(u[s].enemyCOstore[statIndex][0]/8%2 == 1)
                            u[s].noCityResupply = true;
                    }
                }
            }
