...
//used to get the defense bonus for damage calculation
    public int getDef(Unit attacker, Unit defender){
        ...
        if (COP)
            return 110 + defender.getCOstore()[0];
...
//used to deactivate Sabaki's Super CO Power the next day
    ...
    public void afterAttack(Unit owned, Unit enemy, int damage, boolean destroy, boolean attack) {
        ...
        if (attack) //If, first strike
        {
            ...
            if (COP) {
                owned.getCOstore()[0] += (5*damage/10); //Every hitpoint of damage dealt by Sabaki increases her defense by 5. This will probably be dumb, though.
            }
