...
public class TerrainGraphics{
    ...
    public static void loadImages(Component screen){
        ...
        baseUrban = new ImageIcon(imagesLocation + "/terrain/terrain_CW.gif").getImage();
        baseHQ = new ImageIcon(imagesLocation + "/terrain/urban_CW.gif").getImage();
        terrain = new ImageIcon(imagesLocation + "/terrain/HQ_CW.gif").getImage();
